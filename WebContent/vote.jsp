	...
	<body>
		...
		<nav>
			...
			<main id="section">
				...
				<form name="data" method="post" action="vote_p.jsp" onsubmit="return checkValue()">
					<table class="table_line">
					
						<tr>
							<th style="background-color: lightgray;">주민번호</th>
						...
						<tr>
							<th style="background-color: lightgray;">후보번호</th>
							<td>
								<select name="m_no">
						...
						<tr>
							<th style="background-color: lightgray;">투표시간</th>
							<td><input type="text" name="v_time"> 예) 0930 (9시30분)</td>
						</tr>
						<tr>
							<th style="background-color: lightgray;">투표장소</th>
							<td><input type="text" name="m_city"></td>
						</tr>
						<tr>
							<th style="background-color: lightgray;">유권자확인</th>
